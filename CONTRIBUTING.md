...
existing [Issues](https://github.com/benny123tw/javite/issues) that might help you. In case you have
...
- Open an [Issue](https://github.com/benny123tw/javite/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible
  environment components/versions (Make sure that you have read the [documentation](/README.md). If
...
- To see if other users have experienced (and potentially already solved) the same issue you are
  ...
  the [bug tracker](https://github.com/benny123tw/javite/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/benny123tw/javite/issues/new). (Since we can't be
...
This section guides you through submitting an enhancement suggestion for javite, *
...
- Perform a [search](https://github.com/benny123tw/javite/issues) to see if the
...
as [GitHub issues](https://github.com/benny123tw/javite/issues).
...
- **Explain why this enhancement would be useful** to most javite users. You may also
