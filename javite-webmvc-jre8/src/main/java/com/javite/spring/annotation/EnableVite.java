package com.javite.spring.annotation;

import com.javite.spring.config.ViteConfig;
 ...
 * {@link ViteConfig} configuration, which sets up the necessary beans and configuration for using Vite in the application.</p>
 *
 * <p>Usage:</p>
 * <pre class="code">
 * &#64;Configuration
